  ...
  return (
    ...
    >
      ...
      <g transform="translate(6,6)">
        <path d={arc} stroke="#E6F7FF" strokeWidth="0.648" />
      </g>
      <g transform={`translate(${121 - 6},6) scale(-1,1)`}>
        <path d={arc} stroke="#E6F7FF" strokeWidth="0.648" />
      </g>
      <g transform={`translate(6,${121 - 6}) scale(1,-1)`}>
        <path d={arc} stroke="#E6F7FF" strokeWidth="0.648" />
      </g>
      <g transform={`translate(${121 - 6},${121 - 6}) scale(-1,-1)`}>
        <path d={arc} stroke="#E6F7FF" strokeWidth="0.648" />
      </g>
      <text
        x={C}
    ...
    <section className="relative w-full py-16 flex flex-col items-center justify-center overflow-hidden">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, rgba(53,89,199,0.5), #401298 50%, rgba(53,89,199,0.5))",
          }}
        />
        <div
        ...
        <div className="flex flex-col items-center gap-2 w-full max-w-sm">
          <button
            ...
            style={{
              ...
              boxShadow:
                "0px 10px 16.4px rgba(126,58,242,0.1), 0px 4px 6px rgba(126,58,242,0.1), 0px 1px 3px rgba(0,0,0,0.1)",
              fontFamily: "var(--font-raleway)",
              fontWeight: 700,
              fontSize: "1.25rem",
              color: "#374151",
            ...
            onClick={() => (window.location.href = "https://devtoti.com")}
          >
            Visit devtoti.com
          </button>
          <button
            ...
            onClick={() =>
              (window.location.href = "https://www.linkedin.com/in/devtoti/")
            }
          >
            LinkedIn Profile
          </button>
